...
class BaseGenerator extends Generator {
  constructor(args, opts) {
    ...
    if (!shell.which('git')) {
      ...
      this.config.set('ownerName', _.clean(shell.exec('git config user.name', {silent: true}).output, '\n'));
      this.config.set('ownerEmail', _.clean(shell.exec('git config user.email', {silent: true}).output, '\n'));
      this.config.set('ownerHomepage', _.clean(shell.exec('git config user.homepage', {silent: true}).output, '\n'));
    }
